...
import {createProduct, getSupplier, getProduct, getProductById, updateProductById, updateSupplierById, deleteProductById} from "../apis/api";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                {
                    products.map((product) => (
                        ...
                        rounded-3xl h-52 flex items-center justify-between
...
const GetProductById = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-tr from-slate-900 via-cyan-900 p-10">
            ...
            <p className="mb-2">
                <span className="font-bold">supplierId</span>
                {product.supplierId}
            </p>
            <button
...
const UpdateProductById  = () => {
    ...
    const handleUpdate = async () =>  {
        try{
            if(!name || !category || !price || !barcode || !stock || !supplierId) {
                return alert("Fill all fields");
            }
            const updateData = {
                name, category , price , stock ,barcode, supplierId };
